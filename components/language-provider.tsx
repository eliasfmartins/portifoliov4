		...
		projects: {
			...
			list: [
				...
				},
				{
					...
					description:
						"Full stack application for managing real estate listings and users, built with Next.js, TypeScript, and Tailwind CSS on the front end. The back end is powered by Fastify, Node.js, and JWT-based authentication. It uses PostgreSQL hosted on Supabase. Features include property registration, listing, and filtering with a responsive UI and integrated REST API.",
					category: "fullstack",
					technologies: [
						"Next.js",
						"TypeScript",
		...
		projects: {
			...
			list: [
				...
				},
				{
					...
					description:
						"Aplicação full stack para gestão de imóveis e usuários, desenvolvida com Next.js, TypeScript e Tailwind CSS no front-end. No back-end, utiliza Fastify, Node.js e autenticação com JWT. O banco de dados é PostgreSQL, hospedado no Supabase. Permite cadastro, listagem e filtragem de imóveis, com interface responsiva e API REST integrada.",
					category: "fullstack",
					technologies: [
						"Next.js",
						"TypeScript",
